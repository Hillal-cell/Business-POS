    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">Sales Report Table</h4>
                ...
                <div class="card-body table-responsive">
                    <div class="container">
                     ...
                     <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        ...
                        <tbody>
                        @foreach ($salesreporting as $salesreportings)
                        <tr>
                            <td>{{$loop->iteration}}</td>
                            <td>{{$salesreportings->productsale?$salesreportings->productsale->product_name:'-'}}</td>
                            <td>{{$salesreportings->qty}}</td>
                            <td>{{$salesreportings->selling_priceid}}</td>
                            <td>{{$salesreportings->created_at}}</td>
                            <td>
                            </td>
                        </tr>
                        @endforeach
