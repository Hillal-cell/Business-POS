                ...
                <div class="card-body table-responsive">
                    <div class="container">
                     ...
                     <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        ...
                        <tbody>
                        @foreach ($purchasereporting as $salesreportings)
                        <tr>
                            <td>{{$loop->iteration}}</td>
                            <td>{{$salesreportings->coreproductsale?$salesreportings->coreproductsale->core_product:'-'}}</td>
                            <td>{{$salesreportings->qty}}</td>
                            <td>{{$salesreportings->buyingunit}}</td>
